...
export const FARMERS: Farmer[] = [
  {
    ...
    village: "Alanganallur, Madurai",
    locationId: "madurai",
    crops: "tomato, brinjal, bhindi",
    products: ["tomato", "brinjal", "bhindi"],
  ...
  {
    id: "f2",
    name: "Lakshmi Periasamy",
    ta: "லட்சுமி பெரியசாமி",
    phone: "919876543202",
    whatsappNumber: "919876543202",
    village: "Vadipatti, Madurai",
    locationId: "madurai",
    crops: "tomato, spinach, coriander",
    products: ["tomato", "spinach", "coriander"],
    preferredChannel: "WHATSAPP",
    whatsappEnabled: true,
    smsEnabled: true,
    status: "Active",
  ...
  },
  {
    ...
    village: "Melur, Madurai",
    locationId: "madurai",
    crops: "onion, potato, drumstick",
    products: ["onion", "potato", "drumstick"],
    preferredChannel: "WHATSAPP",
    whatsappEnabled: true,
    smsEnabled: true,
    status: "Active",
    ...
    capacityKg: 200,
    lastOrderDays: 1,
    createdAt: "2024-01-10T07:45:00.000Z",
  },
  {
    id: "f4",
    name: "Devi Sundaram",
    ...
    village: "Oddanchatram, Dindigul",
    locationId: "dindigul",
    crops: "tomato, beans, carrot",
    products: ["tomato", "beans", "carrot"],
  ...
  },
  {
    ...
    village: "Palani Road, Dindigul",
    locationId: "dindigul",
    crops: "brinjal, bhindi, drumstick",
    products: ["brinjal", "bhindi", "drumstick"],
    preferredChannel: "WHATSAPP",
    whatsappEnabled: true,
    smsEnabled: true,
    status: "Active",
  ...
  },
  {
    ...
    village: "Usilampatti, Madurai",
    locationId: "madurai",
    crops: "lemon, banana, curryleaf",
    products: ["lemon", "banana", "curryleaf"],
    preferredChannel: "WHATSAPP",
    whatsappEnabled: true,
    smsEnabled: true,
    status: "Active",
  ...
  },
  {
    ...
    village: "Thirumangalam, Madurai",
    locationId: "madurai",
    crops: "ginger, garlic, onion",
    products: ["ginger", "garlic", "onion"],
    preferredChannel: "SMS",
    whatsappEnabled: false,
    smsEnabled: true,
    status: "Active",
  ...
  },
  {
    ...
    village: "Nattam, Dindigul",
    locationId: "dindigul",
    crops: "spinach, coriander, curryleaf",
    products: ["spinach", "coriander", "curryleaf"],
    preferredChannel: "WHATSAPP",
    whatsappEnabled: true,
    smsEnabled: true,
    status: "Active",
  ...
  },
  {
    ...
    village: "Sholavandan, Madurai",
    locationId: "madurai",
    crops: "guava, papaya, banana",
    products: ["guava", "papaya", "banana"],
    preferredChannel: "WHATSAPP",
    whatsappEnabled: true,
    smsEnabled: true,
    status: "Active",
  ...
  },
  {
    ...
    ta: "சின்னசாமி கவுண்டர்",
    phone: "919876543210",
    whatsappNumber: "919876543210",
    village: "Batlagundu, Dindigul",
    locationId: "dindigul",
    crops: "green chilli, capsicum, cucumber",
    products: ["green chilli", "capsicum", "cucumber"],
    preferredChannel: "SMS",
    whatsappEnabled: false,
    smsEnabled: true,
    status: "Inactive",
